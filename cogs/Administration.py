...
class Administration(commands.Cog, name='Administration'):
    ...
    @commands.command(
        ...
        description='Удаляет сообщения (по умолчанию = 5)',
        aliases=['purge', ],
        # usage='`.clear [number of messages]`',
        usage='`.clear [количество сообщений]`'
    )
    @blacklist_check()
    ...
    @commands.command(
        ...
        description='Отправляет ядерную ракету, которая уничтожает все сообщения в текстовом канале',
        usage='`.nuke`'
    )
    @blacklist_check()
    ...
    @commands.command(
        ...
        description='Кикает кого-то с сервера',
        # usage='`.kick [@member]`',
        usage='`.kick [@member]`'
    )
    @blacklist_check()
